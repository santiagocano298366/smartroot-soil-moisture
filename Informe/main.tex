...
\begin{tabular}{rl}
\textbf{Elaborado por:} & [Nombre del Estudiante] \\[4pt]
...
\begin{enumerate}
    ...
    \item \textbf{Integración IoT en tiempo real:} Conectar SmartRoot a una API MQTT o REST para recibir lecturas directamente de microcontroladores de bajo consumo (ESP32, LoRaWAN) instalados en campo, eliminando la dependencia de archivos CSV estáticos.
...
NB05 & \texttt{05\_tablero\_control.ipynb} & Generación del tablero de control integrado con todas las visualizaciones: serie temporal, distribuciones, KPI mensuales, correlaciones y diagrama de flujo. \\
\bottomrule
\end{tabular}
\end{table}
